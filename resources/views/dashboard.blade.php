            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @if (auth()->user()->role->name == 'manager')
                        <span
                            class="text-blue-500 font-boldphp artisan sercve text-xl">{{ __('Received Applications') }}</span>

                        <title>User post card by MichaelFarquhar. </title>
                            ...
                            @foreach ($applications as $application)
                                <div class="rounded-xl border p-5 mt-5 shadow-md w-9/12 bg-white">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <div>
                                            <div
                                                class="border m-6 p-6 rounded hover:bg-gray-50 transition cursor-pointer flex flex-col items-center text-12">
                                    ...
                                    @if (!$application->answers()->exists())
                                        <div class="flex justify-end">
                                            <a href="{{ route('answers.create', ['application' => $application->id]) }}"
                                                type="button"
                                                class="bg-green-500 text-white px-5 py-2 rounded font-medium text-sm mx-3 hover:bg-green-600 transition duration-200 each-in-out">
                                                Answer
                                            </a>
                                        </div>
                                    @else
