                                    ...
                                    <div class='max-w-md mx-auto space-y-6'>
                                        ...
                                        <form action="{{ route('application.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input name="subject" type="text"
                                                class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none" required>
                                            ...
                                            <input name="file" type="file" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded" required>
